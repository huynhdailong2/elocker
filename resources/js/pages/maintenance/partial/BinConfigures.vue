    ...
    <div class="table-scroller mt-3 mb-3" v-if="!!spare">
      <table>
        <thead>
          ...
          <th v-if="spare.has_load_hydrostatic_test_due">Load/Hydrostatic Test Due</th>
        ...
        <tbody>
          <tr v-for="(item, index) in data">
            ...
            <td v-if="spare.has_calibration_due">
              <div class="choose-date">
                ...
                <datepicker
                  ...
                  v-validate="'required'"
                  :data-vv-scope="`${item.scope}`"
                  :class="{'error': errors.has(`${item.scope}.calibration_due`)}"
            ...
            <td v-if="spare.has_load_hydrostatic_test_due">
              <div class="choose-date">
                <label class="checkbox-container">
                  <input type="checkbox" v-model="item.has_load_hydrostatic_test_due">
                  <span class="checkmark"></span>
                </label>
                <datepicker
                  format="dd/MM/yyyy"
                  ...
                  v-validate="'required'"
                  :data-vv-scope="`${item.scope}`"
                  :class="{'error': errors.has(`${item.scope}.load_hydrostatic_test_due`)}"
                  data-vv-as="calibration due"
