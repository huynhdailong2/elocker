<template>
  <div class="spares mb-3">
    ...
    <div class="table-scroller mt-3 mb-3">
      <data-table2 :getData="getSparesReportByTnx"
          :limit="10"
          :column="13"
          :widthTable="'100%'"
        ...
        <template slot="body" slot-scope="props">
          <tr>
            <td :title="props.item.issued_date | dateTimeFormatterLocal('YYYY-MM-DD HH:mm:ss', 'DD-MM-YYYY')" >
              <div class="text ellipsis">{{ props.item.issued_date | dateTimeFormatterLocal('YYYY-MM-DD HH:mm:ss', 'DD-MM-YYYY') }}</div>
            </td>
