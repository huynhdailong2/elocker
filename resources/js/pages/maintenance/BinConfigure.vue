      ...
      >
        ...
        <template slot="body" slot-scope="props">
          <tr>
            ...
            <td>
              <div class="text">{{ props.item.shelf_name }}</div>
            </td>
            <td>
              <div class="text">{{ props.item.row }}</div>
            </td>
            <td>
              <div class="text">{{ props.item.bin }}</div>
            </td>
            <td>
            ...
            <td class="action text-center">
              ...
              <img
                src="/images/icons/icon-cancel.svg"
                width="22px"
                @click.stop="onClickUnAssigned(props.item)"
              />
            </td>
          </tr>
        </template>
