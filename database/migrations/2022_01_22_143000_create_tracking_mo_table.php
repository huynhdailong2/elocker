...
class CreateTrackingMoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tracking_mo', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unsignedBigInteger('issue_card_id');
    ...
    {
        Schema::dropIfExists('tracking_mo');
    }
}
